...
<body>
    <div id="app">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark" id="head">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="navbar-nav mr-auto">
                        ...
                        <div class="nav-item">
                            <a class="nav-link {{ Request::path()==='gallery'? 'active' :''}}" href="/gallery">Gallery</a>
                        </div>
                        <div class="nav-item">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle {{ ( Request::path()==='blogs' || Request::path()==='userblog' || Request::path()==='uploadblog') ? 'active' :''}}" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    Blog
                                </a>
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="/blogs">Blogs</a>
                                    <a class="dropdown-item" href="/view-your-blogs">Your Blogs</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="/upload/blog">Upload Blog</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
